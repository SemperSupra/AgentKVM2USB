...
Fetch all remotes and read issue #27, its draft PR, AGENTS.md, docs/ACTIVE_WORKSTREAMS.md, docs/ISSUE27_OPERATOR_DEPENDENCY_RUNBOOK.md, and prompts/ISSUE27_OPERATOR_DEPENDENCIES.md from origin/issue-27-operator-dependencies.
...
Run claim preflight and, if conflict-free, post a four-hour START claim. Execute the canonical prompt. Complete and validate the dependency preparation implementation, but run only -Plan unless I am physically present and explicitly approve a named UAC action.
...
Update issue #27 and its draft PR, post CHECKPOINT and HANDOFF, release the claim, and report the exact operator actions and remaining Package Foundry blockers.
```
